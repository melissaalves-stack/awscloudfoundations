<div align="center">
  <img src="../assets/header-ia.png" alt="Certificação AI Practitioner" width="100%" />
</div>
...
```mermaid
flowchart LR
    D1["1️⃣ Fund. de<br/>IA e ML"] --> D2["2️⃣ IA<br/>Generativa"]
    D2 --> D3["3️⃣ Aplicações<br/>de Modelos"]
    D3 --> D4["4️⃣ IA<br/>Responsável"]
    D4 --> D5["5️⃣ Segurança e<br/>Governança"]
    D5 --> P["🏆 Prova<br/>AIF-C01"]
```
