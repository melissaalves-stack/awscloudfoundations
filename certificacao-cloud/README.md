<div align="center">
  <img src="../assets/header-cloud.png" alt="Certificação Cloud Practitioner" width="100%" />
</div>
...
```mermaid
flowchart LR
    D1["1️⃣ Conceitos<br/>de Nuvem"] --> D2["2️⃣ Segurança<br/>e Conformidade"]
    D2 --> D3["3️⃣ Tecnologia<br/>e Serviços"]
    D3 --> D4["4️⃣ Cobrança,<br/>Preços e Suporte"]
    D4 --> P["🏆 Prova<br/>CLF-C02"]
```
