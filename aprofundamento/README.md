<div align="center">
  <img src="../assets/header-aprofundamento.png" alt="Aprendizado Aprofundado" width="100%" />
</div>
...
```mermaid
flowchart LR
    A["📚 Estude o<br/>módulo"] --> B["✅ Faça o<br/>quiz"]
    B --> C["🧪 Pratique no<br/>lab"]
    C --> D["📊 Registre seu<br/>Checkpoint"]
    D --> A
```
